  ...
  if (!weather || !weather.days || weather.days.length === 0) {
    return (
      <div className="p-10 border-2 border-dashed border-theme-surface bg-theme-surface/10 rounded-3xl text-center flex items-center justify-center min-h-[124px]">
        <span className="text-[10px]text-theme-muted font-black tracking-widest uppercase">
  ...
  return (
    <div className="rounded-3xl border border-theme-surface bg-theme-white hover:shadow-xl hover:border-theme-muted transition-all duration-200 overflow-hidden">
      <div className="p-6 md:p-8 flex justify-between items-center border-b border-theme-surface bg-theme-surface/20">
        ...
        <div className="px-4 py-2 bg-theme-primary/10 text-theme-primary rounded-xl font-black text-[10px] md:text-[10px]uppercase tracking-widest border border-theme-primary/20">
          ...
          <div key={idx} className="bg-theme-surface/30 rounded-2xl p-5 border border-theme-surface shadow-sm flex items-center justify-between gap-4">
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-[10px] text-theme-muted font-black uppercase tracking-widest">{day.weather}</p>
              </div>
            </div>
