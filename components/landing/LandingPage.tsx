  ...
  return (
    <div className="w-full min-h-screen relative bg-theme-white overflow-x-hidden">
      ...
      <div className="relative z-10 w-[85%] max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 py-16 flex flex-col gap-20 pb-32">
        ...
        <section className="bg-theme-white/20 backdrop-blur-xl rounded-[2rem] shadow-sm border border-theme-surface p-6 animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-3">
              <div className="p-2.5 bg-theme-primary/10 rounded-xl">
                <Compass className="text-theme-primary w-6 h-6" />
              </div>
              <h2 className=" md:text-3xl font-black text-theme-secondary tracking-tight">Popular Destinations</h2>
            </div>
        ...
        <section className="bg-theme-white/20 backdrop-blur-xl rounded-[2rem] shadow-sm border border-theme-surface p-6 sm:p-8 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150 ease-out fill-mode-both">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-3">
              ...
              <h2 className=" md:text-3xl font-black text-theme-secondary tracking-tight">Upcoming Events</h2>
            </div>
                ...
                <Link href={`/events?category=${encodeURIComponent(event.category)}`} key={event.id} className="snap-start min-w-[326px] w-[326px] flex flex-col bg-theme-surface/20 border border-theme-secondary/10 rounded-[2rem] overflow-hidden shadow-sm hover:shadow-xl hover:border-theme-orange/30 transition-all cursor-pointer group flex-shrink-0">
                  <div className="h-48 w-full relative overflow-hidden">
                     ...
                     <div className="absolute top-4 left-4">
                        <span className="px-3 py-1 bg-theme-white/90 backdrop-blur-md rounded-full text-[12px] font-black uppercase tracking-widest text-theme-orange shadow-sm">
                            {event.category}
                        </span>
                    </div>
                  </div>
                  <div className="p-6 flex-1 flex flex-col">
                    <span className="text-[12px] font-black text-theme-orange uppercase tracking-wider mb-2">
                    ...
                    <div className="flex items-center gap-1.5 text-theme-muted text-[12px]font-bold mt-auto pt-4 border-t border-theme-secondary/5">
                      <MapPin size={18} />
