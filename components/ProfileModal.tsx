        ...
        {loading ? (
          ...
          <div className="p-6 flex flex-col gap-5 overflow-y-auto custom-scrollbar flex-1">
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <button
                onClick={() => fileInputRef.current?.click()}
                className="text-[10px]text-theme-primary hover:text-theme-secondary font-bold"
              >
                Change Picture
              </button>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="text-[10px] font-bold tracking-[0.1em] uppercase text-theme-muted ml-1 mb-1 block">
                  Middle Name <span className="text-[10px] opacity-50">(Optional)</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-[10px] font-bold tracking-[0.1em] uppercase text-theme-muted ml-1 mb-1 block">
                  Suffix <span className="text-[10px] opacity-50">(Optional)</span>
                </label>
                <select
