...
export default function Navbar({
  ...
  return (
    <nav className={`w-full flex-shrink-0 z-[150] bg-theme-white transition-all duration-300 ${isSticky ? "sticky top-0 shadow-md" : "relative"}`}>      
      <div className="w-[95%] sm:w-[85%] max-w-[1800px] mx-auto flex items-center justify-between px-2 sm:px-4 md:px-6 text-theme-secondary relative h-[60px]">
        
        <div className="flex items-center flex-shrink-0 h-full">
          <Link href="/" className="flex items-center hover:opacity-90 transition-opacity" onClick={() => setIsMobileMenuOpen(false)}>
            <MinuteBoundLogo className="w-auto transition-all duration-300 h-6 md:h-10" />
          </Link>
        </div>
        ...
        <div className="flex items-center justify-end gap-2 sm:gap-3 flex-shrink-0 h-full">
          ...
          <div className="relative flex items-center h-full" ref={locationRef}>
            <button 
              ...
              className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 py-1.5 rounded-lg bg-theme-surface/30 hover:bg-theme-secondary/10 transition-colors text-theme-secondary font-bold text-[16px] sm: border border-theme-secondary/10 shadow-sm"
            >
            ...
            {isLocationOpen && (
              <div className="absolute right-0 top-[100%] w-[280px] sm:w-[326px] pt-1.5 z-[150]">
                <div className="bg-theme-white rounded-[16px] shadow-[0_16px_40px_rgba(0,0,0,0.12)] border border-theme-secondary/10 p-4 animate-in slide-in-from-top-2 fade-in duration-200">
                  <h4 className="text-[16px]font-black uppercase text-theme-secondary/60 tracking-widest mb-3">Your Residence</h4>
              ...
              <div className="relative flex items-stretch h-full" ref={dropdownRef} onMouseEnter={() => setIsDropdownOpen(true)} onMouseLeave={() => setIsDropdownOpen(false)}>
                ...
                {isDropdownOpen && (
                  <div className="absolute right-0 top-[100%] w-[280px] pt-1.5 z-[150]">
                    <div className="bg-theme-white rounded-[16px] shadow-[0_16px_40px_rgba(0,0,0,0.12)] border border-theme-secondary/10 py-2 animate-in slide-in-from-top-2 fade-in duration-200">
                      
                      <div className="px-4 py-3.5 mb-2 mx-2 border border-theme-secondary/10 bg-theme-secondary/5 flex flex-col gap-0.5 rounded-[16px]">
                      ...
                      <div className="flex flex-col px-2 gap-1">
                        {!isHomePage && (
                          <Link href="/" onClick={() => setIsDropdownOpen(false)} className="group flex items-center gap-3 px-3 py-2.5  font-bold tracking-wide text-theme-secondary/80 hover:text-theme-primary hover:bg-theme-secondary/5 rounded-[16px] transition-all">
                            <Home size={18} className="text-theme-secondary/50 group-hover:text-theme-primary transition-colors" /> Home
                          </Link>
                        )}
                        <Link href="/profile" onClick={() => setIsDropdownOpen(false)} className="group flex items-center gap-3 px-3 py-2.5  font-bold tracking-wide text-theme-secondary/80 hover:text-theme-primary hover:bg-theme-secondary/5 rounded-[16px] transition-all">
                          <UserIcon size={18} className="text-theme-secondary/50 group-hover:text-theme-primary transition-colors" /> Profile Settings
                        </Link>
                        <Link href="/bookings" onClick={() => setIsDropdownOpen(false)} className="group flex items-center gap-3 px-3 py-2.5  font-bold tracking-wide text-theme-secondary/80 hover:text-theme-primary hover:bg-theme-secondary/5 rounded-[16px] transition-all">
                          <Ticket size={18} className="text-theme-secondary/50 group-hover:text-theme-primary transition-colors" /> My Bookings
                        </Link>
                        <Link href="/savedItineraries" onClick={() => setIsDropdownOpen(false)} className="group flex items-center gap-3 px-3 py-2.5  font-bold tracking-wide text-theme-secondary/80 hover:text-theme-primary hover:bg-theme-secondary/5 rounded-[16px] transition-all">
                      ...
                      <div className="px-2">
                        <button onClick={() => { setIsDropdownOpen(false); logout(); }} className="group w-full flex items-center gap-3 px-3 py-2.5  font-bold tracking-wide text-red-500 hover:bg-red-50 hover:text-red-600 rounded-[16px] transition-all text-left">
      ...
      {isMobileMenuOpen && (
        <div className="absolute top-full right-0 w-full bg-theme-white border-b border-theme-secondary/10 shadow-[16px] lg:hidden flex flex-col z-[240] animate-in slide-in-from-top-2 duration-200">
          ...
          <div className="flex flex-col p-4 gap-1.5">
            {!isHomePage && (
              <Link href="/" onClick={() => setIsMobileMenuOpen(false)} className="group flex items-center gap-4 px-4 py-3.5  font-bold tracking-wide text-theme-secondary hover:text-theme-primary hover:bg-theme-secondary/5 rounded-[16px] transition-all">
                <Home size={24} className="text-theme-secondary/50 group-hover:text-theme-primary transition-colors" /> Home
              </Link>
            )}
            {isLoggedIn ? (
              <>
                <Link href="/profile" onClick={() => setIsMobileMenuOpen(false)} className="group flex items-center gap-4 px-4 py-3.5  font-bold tracking-wide text-theme-secondary hover:text-theme-primary hover:bg-theme-secondary/5 rounded-[16px] transition-all">
                  <UserIcon size={24} className="text-theme-secondary/50 group-hover:text-theme-primary transition-colors" /> Profile Settings
                </Link>
                <Link href="/bookings" onClick={() => setIsMobileMenuOpen(false)} className="group flex items-center gap-4 px-4 py-3.5  font-bold tracking-wide text-theme-secondary hover:text-theme-primary hover:bg-theme-secondary/5 rounded-[16px] transition-all">
                  <Ticket size={24} className="text-theme-secondary/50 group-hover:text-theme-primary transition-colors" /> My Bookings
                </Link>
                <Link href="/savedItineraries" onClick={() => setIsMobileMenuOpen(false)} className="group flex items-center gap-4 px-4 py-3.5  font-bold tracking-wide text-theme-secondary hover:text-theme-primary hover:bg-theme-secondary/5 rounded-[16px] transition-all">
                ...
                <button onClick={() => { setIsMobileMenuOpen(false); logout(); }} className="group w-full flex items-center gap-4 px-4 py-3.5  font-bold tracking-wide text-red-500 hover:bg-red-50 hover:text-red-600 rounded-[16px] transition-all text-left">
                  <LogOut size={24} className="text-red-400 group-hover:text-red-500 transition-colors" /> Sign Out
                </button>
              </>
            ) : (
              <Link href="/auth" onClick={() => setIsMobileMenuOpen(false)} className="group flex items-center gap-4 px-4 py-3.5  font-bold tracking-wide text-theme-secondary hover:text-theme-primary hover:bg-theme-secondary/5 rounded-[16px] transition-all">
