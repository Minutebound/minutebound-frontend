  ...
  <div className="flex justify-between items-center mb-6">
    ...
    {data && !loading && (
      <button
        ...
        className="flex items-center text-[16px] gap-2 px-5 py-3 bg-theme-secondary/90 hover:bg-theme-primary/90 text-theme-white text-xs font-bold rounded-[0.5rem] transition-all shadow-md active:scale-110"
      >
        Generate Itinerary
      </button>
    )}
