...
import { Search, Loader2, Calendar, TrendingUp, PenBoxIcon, Map, X, Users, ChevronDown, Plane, Car, DollarSign, GemIcon } from "lucide-react";
...
export default function SearchBar({
  ...
  const renderFullSearchContent = () => (
    <div className="relative w-full z-30 flex flex-col items-center justify-center">
      ...
      <div className={`relative z-10 mx-auto px-6 md:px-6 lg:px-8 py-8 lg:py-12 overflow-visible ${isCompact ? 'w-full max-w-[100%] pt-8 lg:pt-8' : 'w-full max-w-full md:max-w-[90%] lg:max-w-[80%]'}`}>        
        ...
        <div className="bg-theme-white w-full rounded-[2rem] shadow-[0_16px_50px_rgba(0,0,0,0.12)] p-4 md:p-5 lg:p-6 flex flex-col gap-4 relative z-[90]">
          ...
          <div className="flex">
            <div className="relative group cursor-pointer flex items-center">
              <select
                ...
                className="appearance-none text-[12px] bg-theme-primary/10 text-theme-primary uppercase tracking-widest cursor-pointer outline-none py-1 pl-3 pr-8 rounded-lg border border-theme-primary/20 hover:bg-theme-primary/20 transition-all"
              >
          ...
          <div className="flex flex-col lg:flex-row w-full gap-4 lg:gap-3 overflow-visible relative z-[100]">
            ...
            <div className="flex flex-col flex-[1.2] w-full relative z-[100]">
              <div className="flex w-full px-2 lg:px-4 mb-1.5 items-center">
                 <div className="flex-1 flex items-center gap-3">
                     <label className="text-[12px] font-black uppercase tracking-widest text-theme-secondary/60">From</label>
                 </div>
                 <label className="text-[12px] font-black flex-1 uppercase tracking-widest text-theme-secondary/60 pl-4 lg:pl-8">To</label>
              </div>
              ...
              <div className="relative flex flex-row h-12 lg:h-14 bg-theme-white rounded-[1rem] lg:rounded-l-[1rem] border-[1.5px] border-theme-secondary/30 focus-within:border-theme-primary/50 transition-colors shadow-sm group z-[100]">
                {/* Z-INDEX FIX: z-[60] focus-within:z-[100] */}
                <div className="flex-1 relative flex items-center px-3 md:px-5 lg:px-5 rounded-l-[1rem] lg:rounded-l-[1rem] hover:bg-theme-secondary/5 transition-colors border-r border-theme-secondary/20 z-[60] focus-within:z-[100]">
                  <LocationAutocomplete
                    ...
                    showGPS={true}
                  />
                  {errors.source && <span className="absolute -bottom-5 left-4 text-red-500 text-[8px] font-bold">{errors.source}</span>}
                </div>
                ...
                <div className="flex-1 relative flex items-center px-3 md:px-5 lg:px-6 lg:pl-5 rounded-r-[1rem] lg:rounded-r-[1rem] hover:bg-theme-secondary/5 transition-colors z-[60] focus-within:z-[100]">
                  <LocationAutocomplete
                    ...
                    showGPS={false}
                  />
                  {errors.destination && <span className="absolute -bottom-5 left-4 text-red-500 text-[8px] font-bold">{errors.destination}</span>}
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col flex-[1] w-full relative z-[90]">
              <div className="flex w-full px-2 lg:px-4 mb-1.5 items-center">
                 <label className="flex-1 uppercase text-[12px] font-black tracking-widest text-theme-secondary/60">Depart</label>
                 <label className={`flex-1 uppercase text-[12px] font-black tracking-widest text-theme-secondary/60 pl-2 lg:pl-4 ${tripType === 'one-way' ? 'opacity-30' : ''}`}>Return</label>
              </div>
              ...
              <div className="relative flex flex-row h-12 lg:h-14 bg-theme-white rounded-[1rem] lg:rounded-l-[1rem] border-[1.5px] border-theme-secondary/30 focus-within:border-theme-primary/50 transition-colors shadow-sm z-[90]">
                ...
                <div className="flex-1 relative flex items-center px-3 md:px-5 lg:px-5 rounded-l-[1rem] lg:rounded-l-[1rem] hover:bg-theme-secondary/5 transition-colors border-r border-theme-secondary/20 z-[60] focus-within:z-[100]">
                  ...
                  />
                  {errors.start && <span className="absolute -bottom-5 left-4 text-red-500 text-[8px] font-bold">{errors.start}</span>}
                </div>
                ...
                <div className={`flex-1 relative flex items-center px-3 md:px-5 lg:px-5 rounded-r-[1rem] lg:rounded-r-[1rem] transition-colors z-[60] focus-within:z-[100] ${tripType === 'one-way' ? 'bg-theme-secondary/5 cursor-not-allowed' : 'hover:bg-theme-secondary/5'}`}>
                  ...
                  />
                  {errors.end && <span className="absolute -bottom-5 left-4 text-red-500 text-[8px] font-bold">{errors.end}</span>}
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-row flex-wrap sm:flex-nowrap items-center justify-between sm:justify-start gap-1 sm:gap-2 w-full xl:w-auto overflow-visible relative z-50">
              ...
              <div className="relative z-50 shrink-0" ref={travellerRef}>
                <button 
                  ...
                  className="flex items-center gap-1.5 sm:gap-2 font-bold text-[12px] text-theme-secondary hover:text-theme-primary transition-colors py-1 px-1.5 sm:px-2 rounded-lg hover:bg-theme-secondary/10 whitespace-nowrap"
                >
                  ...
                  <div className="absolute top-full left-0 mt-3 w-[260px] sm:w-72 bg-theme-white text-theme-secondary rounded-2xl shadow-xl border border-theme-secondary/20 p-5 z-[100] animate-in fade-in zoom-in-95 duration-200">                    
                    <div className="flex items-center justify-between mb-5">
                      <div>
                        ...
                        <div className="text-[8px] text-theme-muted uppercase tracking-wider">Ages 12+</div>
                      </div>
              ...
              <div className="relative group cursor-pointer flex items-center gap-1 sm:gap-1.5 py-1 px-1.5 sm:px-2 text-[12px] rounded-lg hover:bg-theme-secondary/10 transition-colors whitespace-nowrap shrink-0">
              ...
              <div className="flex items-center gap-1 sm:gap-2 py-1 px-1 sm:px-2 whitespace-nowrap shrink-0 ml-auto sm:ml-0">
                 <span className="text-[12px] font-bold tracking-wider text-theme-secondary hidden sm:inline">Radius:</span>
                 <span className="text-[12px] font-bold uppercase tracking-wider text-theme-secondary sm:hidden">Rad:</span>
                 <input
                    type="number"
                    min={1} 
                    max={100}
                    ...
                    className="w-[42px] sm:w-[52px] bg-theme-secondary/5 border border-theme-secondary/20 rounded-md px-1 py-1 text-[12px] font-bold text-theme-secondary outline-none focus:border-theme-primary focus:ring-1 focus:ring-theme-primary transition-all text-center hide-arrows"
                  />
                 <span className="text-[12px] font-bold uppercase tracking-wider text-theme-secondary">mi</span>
              </div>
            </div>
            ...
            {topDestinations.length > 0 && (
              <div className="flex flex-row items-center w-full xl:w-auto relative z-10 py-1">
                <div className="flex items-center gap-1.5 shrink-0 pr-3">
                   ...
                   <span className="text-[8px] font-black uppercase text-theme-secondary/60 tracking-wider">Trending:</span>
                </div>
                <div className="flex flex-row items-center gap-2 overflow-x-auto no-scrollbar w-full">
                  {topDestinations.map((dest, idx) => (
                    <button
                      ...
                      className="px-4 py-1.5 rounded-full bg-theme-secondary/5 text-theme-secondary/80 text-[8px] font-bold hover:bg-theme-secondary/10 transition-all whitespace-nowrap border border-theme-secondary/10 shadow-sm shrink-0"
                    >
                      {dest.city}
                    </button>
                  ))}
        ...
        <div className="w-full bg-theme-white/50 backdrop-blur-xl py-3 px-4 md:px-6 flex items-center justify-around border-b border-theme-secondary/20 z-20 sticky top-0 shadow-sm transition-all duration-300">
          ...
          <div className="flex items-center">
            ...
            <button
              ...
              className="w-full bg-theme-white border border-theme-secondary/20 shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.08)] rounded-full flex items-center p-1.5 sm:p-2 transition-all duration-300 cursor-pointer group"
            >
              <div className="flex flex-col sm:hidden flex-1 text-left overflow-hidden pl-4 py-1">
                ...
                <div className="flex items-center text-[12px] text-theme-secondary/60 gap-1 mt-[2px] truncate font-medium">
              ...
              <div className="hidden sm:flex items-center justify-between flex-1 pl-2 pr-1">
                <div className="flex items-center flex-1">
                  ...
                  <div className="ml-2 flex items-center gap-1.5 uppercase tracking-widest rounded-full text-[8px] text-theme-secondary font-black bg-theme-primary/10 px-2 py-1 rounded-md shrink-0">
