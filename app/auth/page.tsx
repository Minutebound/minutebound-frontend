...
export default function LoginPage() {
  ...
  const GENDERS = [
    { value: "PREFER_NOT_TO_SAY", label: "Gender not selected" },
    ...
    <div className="min-h-screen flex w-full font-sans bg-theme-white">
      <div className="hidden lg:flex w-1/2 relative bg-theme-secondary overflow-hidden items-end justify-start pb-20 pl-16">
        ...
        <div className="relative z-10 max-w-lg text-theme-white animate-in fade-in slide-in-from-left-8 duration-1000 delay-300 fill-mode-both">
          ...
          <p className=" text-theme-white/80 font-medium">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center relative p-6 sm:p-12 overflow-hidden">
        <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-theme-primary/10 blur-[126px] pointer-events-none"></div>
        <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-theme-secondary/10 blur-[126px] pointer-events-none"></div>

        <div className="w-full max-w-[426px] relative z-10">
          ...
          <div className="mb-8 text-center lg:text-left animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <p className="text-theme-black mt-2 font-medium">
              {isForgotMode
