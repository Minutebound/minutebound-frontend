...
export default function Footer() {
  ...
  if (isCompactMode) {
    return (
      <footer className="bg-theme-dark-blue text-theme-white py-4 border-t-[3px] border-theme-primary z-50 mt-auto w-full">
        <div className="w-[95%] max-w-[2000px] mx-auto px-2 flex flex-col sm:flex-row justify-between items-center gap-3">
          <p className="text-[16px] text-theme-white/50 font-bold tracking-widest uppercase text-center sm:text-left">
            © {new Date().getFullYear()} MinuteBound Travel LLC.
          </p>
          <div className="flex items-center gap-4 sm:gap-6 text-[16px] text-theme-white/50 font-bold tracking-widest uppercase">
  ...
  // --- FULL FOOTER RENDER ---
  return (
    <footer className="bg-theme-dark-blue text-theme-white pt-8 pb-8 border-t-4 border-theme-primary shadow-[0_-4px_24px_rgba(0,0,0,0.05)] z-50 mt-auto w-full">      
      <div className="w-[85%] max-w-[1800px] items-center justify-center mx-auto px-2 md:px-0">
