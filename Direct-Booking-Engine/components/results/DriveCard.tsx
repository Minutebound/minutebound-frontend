    ...
    <div className="flex flex-col gap-4 animate-in fade-in duration-500 w-full">
      ...
      <div 
        className={`rounded-[1rem] border-[1px] transition-all duration-300 overflow-hidden ${
          isSelected ? 'border-theme-primary bg-theme-primary/5 shadow-md shadow-theme-primary/5' : 'border-theme-secondary/20 bg-theme-white hover:border-theme-secondary/40'
        }`}
      >
        {/* --- MAIN CARD --- */}
        <div 
